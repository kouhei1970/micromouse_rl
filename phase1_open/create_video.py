...
def main():
    ...
    output_path = f"outputs/phase1_open/video_{timestamp}.mp4"
    ...
    for i in range(500):
        ...
        cv2.putText(frame_bgr, f"L: {action[0]:.2f} R: {action[1]:.2f}", (10, 60), font, font_scale, color, thickness, cv2.LINE_AA)
