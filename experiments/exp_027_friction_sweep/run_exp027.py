...
U_LEVELS: List[float] = [0.20, 0.30, 0.40, 0.50, 0.60, 0.70, 0.80, 0.90, 1.00]
# 🔴 0.20/0.30/0.40 を追加した（2026-08-20・教授セッション）。理由: u=1.00 と u=0.50 が
# どちらも完走ゼロだったため、中間を埋めるより「そもそも完走できる水準があるか」を
# 先に確かめるほうが情報量が多い。低い側から詰める。
